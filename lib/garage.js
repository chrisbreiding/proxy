...
const persistentData = PersistentData.create('garage-data')
...
const set = (req, res) => {
  ...
  .then((data) => {
    ...
    return data.set(Object.assign(data, update))
  })
  .catch((error) => {
    // eslint-disable-next-line no-console
...
const setNotifyOnOpen = (req, res) => {
  ...
  persistentData.get()
  .then((data) => {
    return data.set(Object.assign(data, { notifyOnOpen }))
  })
  .catch((error) => {
    // eslint-disable-next-line no-console

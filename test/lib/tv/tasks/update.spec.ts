...
describe('lib/tv/tasks/update', () => {
  ...
  it('updates all upcoming/continuing shows', async () => {
    ...
    await updateShowsAndEpisodes(dbMock)

    expect(updateDoc).toBeCalledTimes(4)
    expect(updateDoc).toBeCalledWith(dbMock, 'shows/1', {
      lastUpdated: '2022-12-15T05:00:00.000Z',
      poster: 'show 1 poster',
      status: 'Continuing',
    })
    expect(updateDoc).toBeCalledWith(dbMock, 'shows/3', {
      lastUpdated: '2022-12-15T05:00:00.000Z',
      poster: 'show 3 poster',
      status: 'Ended',
    })
    expect(updateDoc).toBeCalledWith(dbMock, 'shows/4', {
      lastUpdated: '2022-12-15T05:00:00.000Z',
    ...
    expect(setDoc).toBeCalledWith(dbMock, 'shows/1/episodes/all', { episodes: [{
    ...
    expect(setDoc).toBeCalledWith(dbMock, 'shows/3/episodes/all', { episodes: [{
      airdate: '2022-11-12T05:00:00.000Z',
      number: 5,
      id: '6',
      season: 1,
    ...
    expect(setDoc).toBeCalledWith(dbMock, 'shows/4/episodes/all', { episodes: [{
    ...
    expect(updateDoc).toBeCalledWith(dbMock, 'meta/data', {
      error: null,
      lastUpdated: '2022-12-15T05:00:00.000Z',
    })
  })
  ...
  it('errors if getting show fails', async () => {
    ...
    await expect(updateShowsAndEpisodes(dbMock)).rejects
